...
import me.fzzy.vitalcosmetics.listeners.PlayerQuitListener;
...
public class FzzyCosmetics extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        /*if (!pm.isPluginEnabled("VitalPoints")) {
            System.out.println("THIS PLUGIN REQUIRES VITALPOINTS TO FUNCTION");
